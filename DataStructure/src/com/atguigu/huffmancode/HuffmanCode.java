...
public class HuffmanCode {
    ...
    public static void main(String[] args) {
        ...
        //测试压缩文件
        String srcFile = "H://111.xlsx";
        String dstFile = "H://111.zip";
        ...
        //测试解压文件
        String zipFile = "H://111.zip";
        String unZipFile = "H://222.xlsx";
        unZipFile(zipFile, unZipFile);
        System.out.println("解压成功!");


//        String content = "i like like like java do you like a java test more word and see see huffman wpl want to saw wpl>8 ";
//        byte[] contentBytes = content.getBytes();
//        System.out.println("原来的字符串byte" + Arrays.toString(contentBytes) + " 长度：" + contentBytes.length); //40
//
...
//        System.out.println("解压后的字符串：" + new String(sourceBytes));
    ...
    private static byte[] zip(byte[] bytes, Map<Byte, String> huffmanCodes) {
        ...
        //System.out.println("赫夫曼编码字符串==" + stringBuilder.toString());
